...
import com.jay.user.ribbon.client.hystrix.UserRibbonClientHystrixCommand;
...
public class UserRibbonController {
    ...
    public Collection<User> getUsersList() {
        return (Collection<User> ) new UserRibbonClientHystrixCommand(providerServiceName, restTemplate).execute();
    }
